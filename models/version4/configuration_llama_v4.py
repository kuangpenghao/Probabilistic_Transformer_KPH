...
class Method1EConfig_v4(LlamaConfig):
    model_type = "method1e-v4"

class MethodCbaseConfig_v4(LlamaConfig):
    model_type = "methodcbase-v4"

class MethodDbaseConfig_v4(LlamaConfig):
    model_type = "methoddbase-v4"
